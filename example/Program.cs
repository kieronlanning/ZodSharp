...
// Example 7: Union types (simplified - would need proper type handling)
// var stringOrNumberSchema = Z.Union<object>(Z.String(), Z.Number());

// Example 8: Error handling
try
{
    var invalidResult = nameSchema.Parse("AB"); // Too short
}
