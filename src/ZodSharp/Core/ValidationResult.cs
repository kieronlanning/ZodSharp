...
public readonly struct ValidationResult<T>
{
    ...
    private ValidationResult(bool isSuccess, T? value, ImmutableArray<ValidationError> errors)
    {
        IsSuccess = isSuccess;
        Value = value;
        Errors = errors;
    ...
    /// </summary>
    public static ValidationResult<T> Failure(ImmutableArray<ValidationError> errors) => 
